                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if target in label and target=="person":
                            ...
                            print("forward")
                            time.sleep(3)
                            sock.sendto(personCom[1].encode("utf-8"), tello_address1)
                            print("left")
                            time.sleep(3)
                            sock.sendto(personCom[2].encode("utf-8"), tello_address1)
                            print("land")
                            return
                        if target in label and target=="car":
                            sock.sendto(carCom[0].encode("utf-8"), tello_address1)
                            print("forward")
                            time.sleep(3)
                            sock.sendto(carCom[1].encode("utf-8"), tello_address1)
                            print("right")
                            time.sleep(3)
...
message1=["command", "takeoff", "streamon"]
personCom=["forward 160", "left 52", "land"]
